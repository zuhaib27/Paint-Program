 ...
 * @author student
 *
 * Sets up GUI for the Colour panel, and also allos user to change the color of paint as they desire. 
 */
public class ColourPanel extends JPanel implements ActionListener {
	...
	ColourPanel(View view){
		...
		//will be the button to select more advance colours, and the colour of button should show current colour.
	...
	public void actionPerformed(ActionEvent e) {
			//opens a JColorChooser preview box for the user to have more options on colours to select.
			JColorChooser jcc = new JColorChooser();
