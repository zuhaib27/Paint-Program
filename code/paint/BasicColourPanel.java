...
public class BasicColourPanel extends AbstractColorChooserPanel implements ActionListener{
	...
	protected void buildChooser() {
		...
		Color[] colourLabels = {Color.black,  Color.darkGray, Color.gray, Color.lightGray, Color.white,Color.pink, 
				Color.red, Color.orange, Color.yellow, Color.green, Color.cyan, Color.blue, Color.magenta, new Color(165,42,42) };
	...
	public void actionPerformed(ActionEvent e) {
		 Color newColor = null;
	        ...
	        //List of basic colours provided to user. Checks which colour user selected.
